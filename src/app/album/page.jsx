    ...
    return (
        <div className='w-[430px] p-4 bg-gray-900 rounded-lg'>
            <style jsx global>{`
                ...
                // 각 이미지마다 회전 딜레이 추가
                .rotate-image.delay-0 {
                    animation-delay: 0s;
                }
                .rotate-image.delay-1 {
                    animation-delay: 0.5s;
                }
                .rotate-image.delay-2 {
                    animation-delay: 1s;
                }
                .rotate-image.delay-3 {
                    animation-delay: 1.5s;
                }
                .rotate-image.delay-4 {
                    animation-delay: 2s;
                }
                .rotate-image.delay-5 {
            ...
            <div className='flex justify-between gap-4'>
                ...
                <div className='flex flex-col gap-4 w-1/2 image-column relative'>
                    {firstColumn.map((image, index) => (
                        <div key={index} className={`image-wrapper relative rotate-image delay-${index}`}>
                            <div className='image-container overflow-hidden'>
                                <img
                                    src={image}
                                    alt={`Gallery image ${index + 1}`}
                                    className='w-[200px] h-[200px] object-cover transition-transform duration-200 ease-in-out hover:scale-110'
                                />
                            </div>
                        </div>
                    ))}
                ...
                <div className='flex flex-col gap-4 w-1/2 image-column second-column relative'>
                    {secondColumn.map((image, index) => (
                        <div
                            key={index}
                            className={`image-wrapper relative rotate-image delay-${firstColumn.length + index}`}
                        >
                            <div className='image-container overflow-hidden'>
                                <img
                                    src={image}
